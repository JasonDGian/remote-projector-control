...
/**
 * Implementation of the IClassroomParser interface for parsing classroom data from CSV files.
 * This service is responsible for reading a CSV file containing classroom and floor information,
 * checking for existing records in the database, and saving new records.
 */
@Slf4j
@Service
public class IClassroomParserImpl implements IClassroomParser
{
	...
	/**
	 * Parses the classroom and floor information from the provided CSV file (using a scanner).
	 * It reads the data, validates the records, checks the database for existing entries, and saves new ones.
	 * 
	 ...
	 * @throws ProjectorServerException If there is an error during the parsing process.
	 * 
	...
	public String parseClassroom(Scanner scanner) throws ProjectorServerException
	{
		...
		log.debug("Clasroom & Floors parsing process initiated.");
		...
		return "CLASSROOMS: Records saved: " + recordsSaved + " - Records skipped: " + recordsSkipped;
	}
}
